...
; note, low byte is the low 8 bits of the type #
...
SPR_POS_X = 0
SPR_NEG_X = 1
; if the upper most bit of x is set, it's as if the sprit is
; off the scrren to the left
; yo ucan scroll a sprite off the left by setting this
SPR_SIZE_SM = 0
SPR_SIZE_LG = 2
...
; vram increment after the fram write
; register $2115
V_INC_1 = $80
V_INC_32 = $81
...
; see wiki.superfamicom.org/registers for the standard names
...
; When BGMODE is 0-6 (or during vblank in mode 7),
; a fast 16x8 signed multiply is available
; finishing by the next CPU cycle
...
; $2134-36 used for fast multiply see above

oam_read = $2138
vram_read_L = $2139 ; the first read is junk
vram_read_H = $213a ; you need to toss that and then start reads
pal_read_L = $213b
read_scan_H = $213c
read_scan_V = $213d
ppu_status = $213e
...
hdma_enable = $420c
rom_speed = $420d
nim_flag = $4210 ; read once during nmi
